# NOT ONLINE AS API KEY
# from https://www.youtube.com/watch?v=AKQWiqMM4Nk
# python3 -m venv .am               (for Mac)
# source .am/bin/activate           (for Mac)
# python3 -m pip install flask   (for Mac)
# python3 -m pip install -r requirements.txt (for Mac)
# python3 -m pip install openai (for Mac)
# python -m venv john       (for Windows)
# .\john\Scripts\activate   (for Windows)
# pip install flask (for Windows)
# pip install -r requirements.txt   (for Windows)
# pip install openai    (for Windows)
